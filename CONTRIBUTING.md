...
[good first issue](https://github.com/spltcrypto/superlinktech/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or participate in a weekly [Bitcoin Core PR Review Club](https://superlinktechcore.reviews/) meeting.

Communication Channels
----------------------

Most communication about Bitcoin Core development happens on IRC, in the
#superlinktech-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/superlinktech-core-dev/](http://www.erisian.com.au/superlinktech-core-dev/)
and [http://gnusha.org/superlinktech-core-dev/](http://gnusha.org/superlinktech-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/superlinktech-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to superlinktech-qt
...
[Translation Process](https://github.com/spltcrypto/superlinktech/blob/master/doc/translation_process.md)
...
https://github.com/spltcrypto/superlinktech/pull/16189).

Also see the [backport.py script](
https://github.com/superlinktech-core/superlinktech-maintainer-tools#backport).
