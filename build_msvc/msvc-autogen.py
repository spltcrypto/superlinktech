...
libs = [
    'libsuperlinktech_cli',
    'libsuperlinktech_common',
    'libsuperlinktech_crypto',
    'libsuperlinktech_server',
    'libsuperlinktech_util',
    'libsuperlinktech_wallet_tool',
    'libsuperlinktech_wallet',
    'libsuperlinktech_zmq',
    'bench_superlinktech',
    'libtest_util',
]
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/superlinktech_config.h'), os.path.join(SOURCE_DIR, 'config/superlinktech-config.h'))
