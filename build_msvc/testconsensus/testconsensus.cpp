...
// superlinktech includes.
#include <..\src\script\superlinktechconsensus.h>
...
int main()
{
    std::cout << "superlinktechconsensus version: " << superlinktechconsensus_version() << std::endl;
    ...
    auto op0Result = superlinktechconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, superlinktechconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
