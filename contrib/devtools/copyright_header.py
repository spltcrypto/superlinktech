...
EXCLUDE = [
    # auto generated:
    'src/qt/superlinktechstrings.cpp',
...
Arguments:
    <base_directory> - The base directory of a superlinktech source code repository.
...
Arguments:
    <file> - A source file in the superlinktech repository.
"""
