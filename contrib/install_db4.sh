...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the superlinktech repository."
  exit 1
fi
...
# See https://github.com/spltcrypto/superlinktech/issues/16064
...
echo 'When compiling superlinktechd, run `./configure` in the following way:'
echo
