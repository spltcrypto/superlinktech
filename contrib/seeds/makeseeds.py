...
def main():
    ...
    # Filter out hosts with multiple superlinktech ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple superlinktech ports' % (ip_stats(ips)), file=sys.stderr)
