...
class PSBTTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 SPLT
        ...
        # feeRate of 0.1 SPLT / KB produces a total fee slightly below -maxtxfee (~0.05280000):
        ...
        # feeRate of 10 SPLT / KB produces a total fee well above -maxtxfee
