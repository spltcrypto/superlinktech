...
- The oldest supported Python version is specified in [doc/dependencies.md](/doc/dependencies.md).
  ...
  The Travis linter also checks this, but [possibly not in all cases](https://github.com/spltcrypto/superlinktech/pull/14884#discussion_r239585126).
...
- Set the `self.setup_clean_chain` variable in `set_test_params()` to control whether
  ...
  has 25 mature blocks (25x50=1250 SPLT) in its wallet.
...
with the superlinktechd(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a superlinktechd.  `P2PInterface`
...
Taken from the [python-superlinktechrpc repository](https://github.com/jgarzik/python-superlinktechrpc).
...
Basic code to support P2P connectivity to a superlinktechd.

#### [script.py](test_framework/script.py)
Utilities for manipulating transaction scripts (originally from python-superlinktechlib)
