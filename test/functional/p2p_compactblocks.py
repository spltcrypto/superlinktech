...
# TestP2PConn: A peer we use to send messages to superlinktechd, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    def test_sendcmpct(self, test_node, old_node=None):
        ...
        # Make sure we get a SESPLTMPCT message from our peer
        ...
        # Now try a SESPLTMPCT message with too-high version
        ...
        # Now try a SESPLTMPCT message with valid version, but announce=False
        ...
        # Finally, try a SESPLTMPCT message with announce=True
        sendcmpct.version = preferred_version
        sendcmpct.announce = True
        test_node.send_and_ping(sendcmpct)
    ...
    # This test actually causes superlinktechd to (reasonably!) disconnect us, so do this last.
    ...
    # superlinktechd's choice of nonce.
    ...
    # Test that superlinktechd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for superlinktechd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # superlinktechd will not send blocktxn responses for blocks whose height is
    ...
    def run_test(self):
        ...
        self.log.info("Testing SESPLTMPCT p2p message... ")
