...
class BackwardsCompatibilityTest(BitcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        self.add_nodes(self.num_nodes, extra_args=self.extra_args, versions=[
            ...
            self.options.superlinktechd,
            self.options.superlinktechd,
            releases_path + "/v0.19.0.1/bin/superlinktechd",
            releases_path + "/v0.18.1/bin/superlinktechd",
            releases_path + "/v0.17.1/bin/superlinktechd"
        ], binary_cli=[
            self.options.superlinktechcli,
            self.options.superlinktechcli,
            releases_path + "/v0.19.0.1/bin/superlinktech-cli",
            releases_path + "/v0.18.1/bin/superlinktech-cli",
            releases_path + "/v0.17.1/bin/superlinktech-cli"
        ])
    ...
    def run_test(self):
        ...
        # RPC loadwallet failure causes superlinktechd to exit, in addition to the RPC
