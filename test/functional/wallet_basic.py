...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 SPLT from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 SPLT in block rewards plus fees, but
        ...
        # Send 10 SPLT with subtract fee from amount
        ...
        # Sendmany 10 SPLT with subtract fee from amount
        ...
        # This will raise an exception for attempting to get the private key of an invalid SuperLinkTech address
        assert_raises_rpc_error(-5, "Invalid SuperLinkTech address", self.nodes[0].dumpprivkey, "invalid")

        # This will raise an exception for attempting to set a label for an invalid SuperLinkTech address
        assert_raises_rpc_error(-5, "Invalid SuperLinkTech address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_rpc_error(-5, "Invalid SuperLinkTech address or script", self.nodes[0].importaddress, "invalid")
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/spltcrypto/superlinktech/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
