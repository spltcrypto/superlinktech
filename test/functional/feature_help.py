...
"""Verify that starting superlinktech with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start superlinktech with -h for help text")
        ...
        self.log.info("Start superlinktech with -version for version information")
        ...
        self.log.info("Start superlinktechd with -fakearg to make sure it does not start")
