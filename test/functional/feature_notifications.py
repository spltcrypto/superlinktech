...
class NotificationsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_wallet_compiled():
            ...
            # https://github.com/spltcrypto/superlinktech/pull/9371, it might be better
            ...
            # https://github.com/spltcrypto/superlinktech/pull/16624. The bug is reported
            # in issue https://github.com/spltcrypto/superlinktech/issues/18325.
