...
```sh
$ git clone https://github.com/spltcrypto/superlinktech
$ cd superlinktech/
$ ./autogen.sh
$ CC=clang CXX=clang++ ./configure --enable-fuzz --with-sanitizers=address,fuzzer,undefined
# macOS users: If you have problem with this step then make sure to read "macOS hints for
# libFuzzer" on https://github.com/spltcrypto/superlinktech/blob/master/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/spltcrypto/superlinktech/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/spltcrypto/superlinktech/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/spltcrypto/superlinktech/tree/master/src/test/fuzz).
...
The project's collection of seed corpora is found in the [`superlinktech-core/qa-assets`](https://github.com/superlinktech-core/qa-assets) repo.

To fuzz `process_message` using the [`superlinktech-core/qa-assets`](https://github.com/superlinktech-core/qa-assets) seed corpus:

```sh
$ git clone https://github.com/superlinktech-core/qa-assets
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`superlinktech-core/qa-assets`](https://github.com/superlinktech-core/qa-assets) repo.

Every single pull request submitted against the Bitcoin Core repo is automatically tested against all inputs in the [`superlinktech-core/qa-assets`](https://github.com/superlinktech-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Bitcoin Core more robust.
...
with certain assembly code from Bitcoin Core's code. See [developer notes on sanitizers](https://github.com/spltcrypto/superlinktech/blob/master/doc/developer-notes.md#sanitizers)
