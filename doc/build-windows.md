...
example /usr/src/superlinktech, AND not under /mnt/d/. If this is not the case the dependency autoconf scripts will fail.
...
way. This will install to `c:\workspace\superlinktech`, for example:

    make install DESTDIR=/mnt/c/workspace/superlinktech
