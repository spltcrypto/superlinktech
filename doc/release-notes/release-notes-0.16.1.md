Bitcoin Core version 0.16.1 is now available from:
  ...
  <https://superlinktechcore.org/bin/superlinktech-core-0.16.1/>
...
- #12843 `df38b13` Test starting superlinktechd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure superlinktechd processes are cleaned up when tests end (sdaftuar)
