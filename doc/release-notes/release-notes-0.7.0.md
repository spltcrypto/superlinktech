Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/superlinktech/files/Bitcoin/superlinktech-0.7.0/

We recommend that everybody running prior versions of superlinktechd/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/spltcrypto/superlinktech/tarball/v0.7.0  # .tar.gz
  https://github.com/spltcrypto/superlinktech/zipball/v0.7.0  # .zip
...
in your terminal, then install the superlinktech-qt package:
  sudo apt-get install superlinktech-qt
...
(on Mac) or
Code:
superlinktechd/superlinktech-qt
(on Linux).
...
Core superlinktech handling and blockchain database
...
* Ensure a changed superlinktech unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for superlinktech-qt.exe
* (Windows only): add meta-data to superlinktech-qt.exe (e.g. description)
...
* Bash programmable completion for superlinktechd(1)
