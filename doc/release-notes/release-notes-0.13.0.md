Bitcoin Core version 0.13.0 is now available from:
  ...
  <https://superlinktech.org/bin/superlinktech-core-0.13.0/>
...
updates will be released anymore. Without security updates, using a superlinktech
wallet on a XP machine is irresponsible at least.

In addition to that, with 0.12.x there have been varied reports of Bitcoin Core
randomly crashing on Windows XP. It is [not clear](https://github.com/spltcrypto/superlinktech/issues/7681#issuecomment-217439891)
...
- Adding `dbcache=100` in superlinktech.conf
...
superlinktech-cli: arguments privacy
------------------------------
...
For example:
    ...
    $ src/superlinktech-cli -stdin walletpassphrase
    mysecretcode
    120
...
- `superlinktech-${VERSION}-arm-linux-gnueabihf.tar.gz`: Linux binaries targeting
  the 32-bit ARMv7-A architecture.
- `superlinktech-${VERSION}-aarch64-linux-gnu.tar.gz`: Linux binaries targeting
...
compatible peers.
[BIP 152](https://github.com/superlinktech-project/bips/blob/master/bip-0152.mediawiki)
...
[Pull request](https://github.com/spltcrypto/superlinktech/pull/8035/files), [BIP 32](https://github.com/superlinktech-project/bips/blob/master/bip-0032.mediawiki)
...
141](https://github.com/superlinktech-project/bips/blob/master/bip-0141.mediawiki), [BIP
143](https://github.com/superlinktech-project/bips/blob/master/bip-0143.mediawiki), [BIP
144](https://github.com/superlinktech-project/bips/blob/master/bip-0144.mediawiki), and [BIP
145](https://github.com/superlinktech-project/bips/blob/master/bip-0145.mediawiki) are
...
Witness)] (https://github.com/superlinktech-project/bips/blob/master/bip-0141.mediawiki).
...
(https://github.com/superlinktech-project/bips/blob/master/bip-0141.mediawiki) for additional
details.)
...
- The optional new p2p message "feefilter" is implemented and the protocol
  ...
  feerate. [BIP 133](https://github.com/superlinktech-project/bips/blob/master/bip-0133.mediawiki)
...
65](https://github.com/superlinktech-project/bips/blob/master/bip-0065.mediawiki)

  - OP_NOP3 has been renamed to OP_CHECKSEQUENCEVERIFY by [BIP 
112](https://github.com/superlinktech-project/bips/blob/master/bip-0112.mediawiki)
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/spltcrypto/superlinktech/pull/7762).
...
- #7550 `8b958ab` Input-from-stdin mode for superlinktech-cli (laanwj)
...
- #7613 `3798e5d` Add autocomplete to superlinktech-qt's console window (GamerSg)
...
- #7636 `fb0ac48` Add superlinktech address label to request payment QR code (makevoid)
- #8231 `760a6c7` Fix a bug where the SplashScreen will not be hidden during startup (jonasschnelli)
- #8256 `af2421c` BUG: superlinktech-qt crash (fsb4000)
- #8257 `ff03c50` Do not ask a UI question from superlinktechd (sipa)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for superlinktechd procs (MarcoFalke)
...
- #7744 `d8e862a` test_framework: detect failure of superlinktechd startup (laanwj)
...
- #7975 `fc23fee` Update superlinktech-core GitHub links (MarcoFalke)
