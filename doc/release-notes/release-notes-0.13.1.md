Bitcoin Core version 0.13.1 is now available from:
  ...
  <https://superlinktech.org/bin/superlinktech-core-0.13.1/>
...
- **Signature covers value:** A simple improvement in the way signatures are
  ...
  of superlinktechs they think they are spending, and by having full nodes refuse to
  accept those signatures unless the amount of superlinktechs being spent is exactly
...
- **Increased security for multisig:** SuperLinkTech addresses (both P2PKH addresses
...
[Segwit FAQ]: https://superlinktechcore.org/en/2016/01/26/segwit-benefits/
[segwit wallet Developers guide]: https://superlinktechcore.org/en/segwit_wallet_dev/
[BIP141]: https://github.com/superlinktech-project/bips/blob/master/bip-0141.mediawiki
[BIP143]: https://github.com/superlinktech-project/bips/blob/master/bip-0143.mediawiki
[BIP144]: https://github.com/superlinktech-project/bips/blob/master/bip-0144.mediawiki
[BIP145]: https://github.com/superlinktech-project/bips/blob/master/bip-0145.mediawiki
[versionbits FAQ]: https://superlinktechcore.org/en/2016/06/08/version-bits-miners-faq/
...
[BIP147]: https://github.com/superlinktech-project/bips/blob/master/bip-0147.mediawiki
...
- #8848 `7a34a46` Add NULLDUMMY verify flag in superlinktechconsensus.h (jl2012)
...
- #8940 `5b4192b` Add x9 service bit support to dnsseed.bluematt.me, seed.superlinktechstats.com (TheBlueMatt, cdecker)
- #8944 `685e4c7` Remove bogus assert on number of oubound connections. (TheBlueMatt)
- #8949 `0dbc48a` Be more agressive in getting connections to peers with relevant services (gmaxwell)

### Build system
- #8293 `fa5b249` Allow building libsuperlinktechconsensus without any univalue (luke-jr)
- #8492 `8b0bdd3` Allow building bench_superlinktech by itself (luke-jr)
...
- #8829 `2a8bca4` Add superlinktech-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` superlinktech-util-test.py should fail if the output file is empty (jnewbery)
...
- #8860 `0bee740` util: Move wait_superlinktechds() into stop_nodes() (MarcoFalke)
...
- #8683 `8a7d7ff` Fix incorrect file name superlinktech.qrc  (superlinktechsSG)
...
- #8817 `bcf3806` update superlinktech-tx to output witness data (jnewbery)
