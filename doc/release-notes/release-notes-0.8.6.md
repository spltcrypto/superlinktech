Bitcoin-Qt version 0.8.6 final is now available from:
  ...
  http://sourceforge.net/projects/superlinktech/files/Bitcoin/superlinktech-0.8.6/
...
Note: Gavin Andresen's GPG signing key for SHA256SUMS.asc has been changed from  key id 1FC730C1 to sub key 7BF6E212 (see https://github.com/spltcrypto/superlinktech.org/pull/279).
