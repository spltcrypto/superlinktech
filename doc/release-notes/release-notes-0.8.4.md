Bitcoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/superlinktech/files/Bitcoin/superlinktech-0.8.4/
...
code, causing the Bitcoin-Qt or superlinktechd process to crash.
Bloom filters were introduced with version 0.8, so versions 0.8.0
through 0.8.3 are vulnerable to this critical denial-of-service attack.

A constant-time algorithm is now used to check RPC password
guess attempts; fixes https://github.com/spltcrypto/superlinktech/issues/2838
(CVE-2013-4165)
...
Linux: clicking on superlinktech: links was broken if you were using
