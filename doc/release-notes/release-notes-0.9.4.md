Bitcoin Core version 0.9.4 is now available from:
  ...
  https://superlinktech.org/bin/0.9.4/
...
Bitcoin Core released binaries from https://superlinktech.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~superlinktech/+archive/ubuntu/superlinktech
