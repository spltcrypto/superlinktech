Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://superlinktech.org/bin/superlinktech-core-0.13.2/>
...
- #8908 `4a974b2` Update superlinktech-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow superlinktech-tx to create v2 transactions (BTCdrak)
