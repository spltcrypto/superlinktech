superlinktechd and Bitcoin-Qt version 0.5.5 are now available for download at:
Windows: installer | zip (sig)
Source: tar.gz
superlinktechd and Bitcoin-Qt version 0.6.0.7 are also tagged in git, but it is recommended to upgrade to 0.6.1.
...
Correct sign message superlinktech address tooltip. Fixes #1050 (Bitcoin-Qt)
