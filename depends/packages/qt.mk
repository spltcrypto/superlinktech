...
$(package)_config_opts_darwin += -device-option SPLTS_COMPILE="$(host)-"
...
$(package)_config_opts_arm_linux += -platform linux-g++ -xplatform superlinktech-linux-g++
$(package)_config_opts_i686_linux  = -xplatform linux-g++-32
$(package)_config_opts_x86_64_linux = -xplatform linux-g++-64
$(package)_config_opts_aarch64_linux = -xplatform linux-aarch64-gnu-g++
$(package)_config_opts_powerpc64_linux = -platform linux-g++ -xplatform superlinktech-linux-g++
$(package)_config_opts_powerpc64le_linux = -platform linux-g++ -xplatform superlinktech-linux-g++
$(package)_config_opts_riscv64_linux = -platform linux-g++ -xplatform superlinktech-linux-g++
$(package)_config_opts_s390x_linux = -platform linux-g++ -xplatform superlinktech-linux-g++

$(package)_config_opts_mingw32 = -no-opengl
$(package)_config_opts_mingw32 += -no-dbus
$(package)_config_opts_mingw32 += -xplatform win32-g++
$(package)_config_opts_mingw32 += -device-option SPLTS_COMPILE="$(host)-"

$(package)_config_opts_android = -xplatform android-clang
$(package)_config_opts_android += -android-sdk $(ANDROID_SDK)
$(package)_config_opts_android += -android-ndk $(ANDROID_NDK)
$(package)_config_opts_android += -android-ndk-platform android-$(ANDROID_API_LEVEL)
$(package)_config_opts_android += -device-option SPLTS_COMPILE="$(host)-"
...
define $(package)_preprocess_cmds
  ...
  cp -r qtbase/mkspecs/linux-arm-gnueabi-g++ qtbase/mkspecs/superlinktech-linux-g++ && \
  sed -i.old "s/arm-linux-gnueabi-/$(host)-/g" qtbase/mkspecs/superlinktech-linux-g++/qmake.conf && \
  ...
  sed -i.old "s/LIBRARY_PATH/(SPLTS_)?\0/g" qtbase/mkspecs/features/toolchain.prf
endef
