...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_superlinktech` executable (see https://github.com/spltcrypto/superlinktech/pull/13543),
...
options will be passed to superlinktech's configure. In this case, `--disable-wallet`.
