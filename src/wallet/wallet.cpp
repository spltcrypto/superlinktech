...
bool CWallet::AddToWallet(const CWalletTx& wtxIn, bool fFlushOnClose)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/spltcrypto/superlinktech/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/spltcrypto/superlinktech/pull/13339#issuecomment-461288094
...
{
    // If wallet doesn't have a chain (e.g superlinktech-wallet), lock can't be taken.
    ...
    while (block_height && !fAbortRescan && !chain().shutdownRequested()) {
        ...
        if (chain().findBlock(block_hash, &block) && !block.IsNull()) {
            ...
            if (!locked_chain->getBlockHeight(block_hash)) {
                ...
                // https://github.com/spltcrypto/superlinktech/pull/14711#issuecomment-458342518
                         ...
                         int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    int nBytes;
    {
        ...
        LOCK(cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-superlinktech-address
...
DBErrors CWallet::LoadWallet(bool& fFirstRunRet)
{
    ...
    // tx status. If lock can't be taken (e.g superlinktech-wallet), tx confirmation
 ...
 * https://superlinktechtalk.org/?topic=54527, or
 * https://github.com/spltcrypto/superlinktech/pull/1393.
 */
...
int CWalletTx::GetBlocksToMaturity() const
{
    ...
    //SPLTTODO Some wallets are still not abandoning coinstakes correctly
...
void CWallet::StakeSPLTs(bool fStake, CConnman* connman, CTxMemPool* mempool)
{
    ::StakeSPLTs(fStake, this, connman, mempool, stakeThread);
}

void CWallet::StartStake(CConnman *connman, CTxMemPool* mempool)
{
    m_enabled_staking = true;
    StakeSPLTs(true, connman, mempool);
}
