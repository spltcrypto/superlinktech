...
/* A AEAD class for ChaCha20-Poly1305@superlinktech.
 *
 ...
 *
 * The chacha20-poly1305@superlinktech combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@superlinktech cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@superlinktech are relatively fast in
