...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SuperLinkTech address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and SuperLinkTech : URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SuperLinkTech addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SuperLinkTech addresses"));
    ...
    openAction->setStatusTip(tr("Open a superlinktech: URI"));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to SuperLinkTech network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
