...
<context>
    ...
    <message>
        ...
        <translation>Θυμίσου ότι το να κρυπτογραφείς το πορτοφόλι σου δεν μπορεί να προστατέψει πλήρως τα superlinktechs σου από κλοπή από  κακόβουλο λογισμικό που έχει μολύνει τον υπολογιστή σου</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Στείλε νομίσματα σε μια διεύθυνση superlinktech</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Αίτηση πληρωμών (δημιουργεί QR codes και διευθύνσεις superlinktech: )</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ανοίξτε ένα superlinktech: URI</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Η προσπάθεια να δαπανήσετε superlinktechs που επηρεάζονται από τις μη εμφανιζόμενες ακόμη συναλλαγές δεν θα γίνει αποδεκτή από το δίκτυο.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Ανοίξτε το SuperLinkTech URI</translation>
    </message>
    <message>
        <source>URI:</source>
...
<context>
    ...
    <message>
        ...
        <translation>Δεν είναι δυνατή η εκκίνηση του superlinktech: χειριστής click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>'superlinktech: //' δεν είναι έγκυρο URI. Χρησιμοποιήστε το "superlinktech:" αντ 'αυτού.</translation>
    </message>
    <message>
...
Σημείωση: Δεδομένου ότι η χρέωση υπολογίζεται ανά βάση, η αμοιβή "100 satoshis ανά kB" για ένα μέγεθος συναλλαγής 500 bytes (το μισό του 1 kB) θα αποφέρει τέλος μόνο 50 satoshis.</translation>
    ...
    <message>
        ...
        <translation>Όταν υπάρχει λιγότερος όγκος συναλλαγών από το χώρο στα μπλοκ, οι ανθρακωρύχοι καθώς και οι κόμβοι αναμετάδοσης μπορούν να επιβάλουν ένα ελάχιστο τέλος. Η πληρωμή μόνο αυτού του ελάχιστου τέλους είναι μια χαρά, αλλά γνωρίζετε ότι αυτό μπορεί να οδηγήσει σε μια συναλλαγή που δεν επιβεβαιώνει ποτέ τη στιγμή που υπάρχει μεγαλύτερη ζήτηση για συναλλαγές superlinktech από ό, τι μπορεί να επεξεργαστεί το δίκτυο.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Το τέλος θα αφαιρεθεί από το ποσό που αποστέλλεται. Ο παραλήπτης θα λάβει λιγότερα superlinktechs από ό,τι εισάγετε στο πεδίο ποσό. Εάν επιλεγούν πολλοί παραλήπτες, το έξοδο διαιρείται εξίσου.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ένα μήνυμα που επισυνάφθηκε στο superlinktech: URI το οποίο θα αποθηκευτεί με τη συναλλαγή για αναφορά. Σημείωση: Αυτό το μήνυμα δεν θα σταλεί μέσω του δικτύου Bitcoin.</translation>
    </message>
    <message>
        <source>Pay To:</source>
        <translation>Πληρωμή σε:</translation>
