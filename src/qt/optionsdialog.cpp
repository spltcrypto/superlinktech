    ...
    mapper(nullptr)
{
    ...
    ui->superlinktechAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->superlinktechAtStartup);
    ...
    ui->superlinktechAtStartup->setToolTip(ui->superlinktechAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->superlinktechAtStartup->setText(ui->superlinktechAtStartup->text().arg(PACKAGE_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->superlinktechAtStartup, OptionsModel::StartAtStartup);
