...
public:
    ...
    QSize minimumSizeHint() const
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = GUIUtil::TextWidth(fm, BitcoinUnits::format(BitcoinUnits::SPLT, BitcoinUnits::maxMoney(), false, BitcoinUnits::separatorAlways));
...
private:
    int currentUnit{BitcoinUnits::SPLT};
...
#include <qt/superlinktechamountfield.moc>
