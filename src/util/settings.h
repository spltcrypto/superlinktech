...
//!       https://github.com/spltcrypto/superlinktech/pull/15934/files#r337691812)
using SettingsValue = UniValue;

//! Stored superlinktech settings. This struct combines settings from the command line
