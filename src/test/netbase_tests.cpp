...
{
    BOOST_CHECK(TestSplitHost("www.superlinktechcore.org", "www.superlinktechcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.superlinktechcore.org]", "www.superlinktechcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.superlinktechcore.org:80", "www.superlinktechcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.superlinktechcore.org]:80", "www.superlinktechcore.org", 80));
